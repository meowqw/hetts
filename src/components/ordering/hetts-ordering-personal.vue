        ...
        <div class="col-md-12 checkout__form">
          ...
          <template v-if="form.legal_status === 2">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input
                      v-model="form.extra_data.company_address"
                      type="text"
                      class="form-control"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input v-model="form.extra_data.payment_account" type="text" class="form-control"
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input v-model="form.extra_data.correspondent_account" required type="text" class="form-control"
                         placeholder="Корреспондентский счет">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input v-model="form.extra_data.bic" required type="text" class="form-control"
                         placeholder="БИК">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input v-model="form.extra_data.bank" required type="text" class="form-control"
                         placeholder="Банк">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group mt-5">
                  <input v-model="form.extra_data.ceo" required type="text" class="form-control"
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group mt-5">
                <input
                    v-model="form.extra_data.transport_company"
                    type="text"
                    class="form-control"
            ...
            <div class="col-md-6">
              <div class="form-group mt-5">
                <select
                    v-model="form.extra_data.type_shop"
                    class="form-control"
