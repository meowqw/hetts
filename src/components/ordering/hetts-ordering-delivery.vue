...
<script>
export default {
  name: "hetts-ordering-delivery",
  data() {
    return {
      delivery_methods: [
        {id: 1, title: 'САМОВЫВОЗ СКЛАД МОСКВА', description: 'Самовывоз со склада в Москве.'},
        {id: 2, title: 'ТРАНСПОРТНАЯ КОМПАНИЯ', description: 'Для регионов России и других стран'},
      ],
      delivery_method_id: ''
    }
